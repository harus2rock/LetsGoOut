...
public class GoOutActivity extends AppCompatActivity implements OnMapReadyCallback {
    private static final String TAG = "GoOutActivity";
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latlng, 17));
    ...
    public static class AlertDialogFragment extends DialogFragment {
        ...
        private void stop(boolean saveLog){
            GoOutActivity goOutActivity = (GoOutActivity) getActivity();
            if(goOutActivity != null){
                goOutActivity.stopLogging(saveLog);
            }
        }
    }
}
